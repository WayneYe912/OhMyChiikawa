...
OhMyChiikawa 是一个轻量的桌面宠物。启动后，默认角色 **吉伊（Chiikawa）** 会出现在桌面上，你也可以在右键菜单里随时切换到 **乌萨奇**。两个角色都可以拖动、点击互动、跟随鼠标、偶尔自己走动，也会在待机时眨眼和轻微摆动耳朵。
...
- 多角色形象：内置 **吉伊** 和 **乌萨奇** 两个形象，右键菜单可随时切换，并自动记住上次的选择。
- 透明、无边框、默认置顶显示。
- 拖动摆放：按住角色即可拖到屏幕任意位置。
...
OhMyChiikawa is a lightweight desktop pet. After launch, the default character **Chiikawa** appears on your desktop, and you can switch to **usagi** anytime from the right-click menu. Both characters can be dragged around, clicked on different body parts, follow the cursor, wander occasionally, and play idle animations such as blinking and subtle ear movement.
...
- Multiple characters: **Chiikawa** and **usagi** are both built in; switch anytime from the context menu, and your last choice is remembered.
...
| Menu: Character        | Switch between Chiikawa and usagi (remembered)   |
